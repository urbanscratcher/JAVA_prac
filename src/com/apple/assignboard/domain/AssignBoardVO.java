...
public class AssignBoardVO extends DTO implements Comparable {
	...
	private String startDate; // 과제시작일 : 사용자 입력값
	private String dueDate; // 과제마감일 : 사용자 입력값
	...
	public AssignBoardVO(String assgnNo, String title, String contents, Date regDate, String startDate, String dueDate) {
	...
	public String getRegDateStr() {
		return StringUtil.formatDate(regDate, "yyyy-MM-dd HH:mm:ss");
	}
	...
	public void setRegDateStr(String regDate) {
		this.regDate = StringUtil.stringToDate(regDate);
	}
